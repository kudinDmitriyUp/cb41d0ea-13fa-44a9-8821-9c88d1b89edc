...
export const metadata: Metadata = {
  title: "RedBlack Agency - Bold Marketing That Drives Results",
  description: "Transform your business with powerful marketing campaigns. We create bold strategies that amplify your brand and deliver measurable growth.",
  keywords: ["marketing agency", "digital marketing", "brand strategy", "marketing campaigns", "business growth"],
  ...
  openGraph: {
    title: "RedBlack Agency - Bold Marketing That Drives Results",
    description: "Transform your business with powerful marketing campaigns that deliver measurable growth.",
    siteName: "RedBlack Agency",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1763138766365-waqqmfei.jpg",
      alt: "RedBlack Marketing Agency"
    }]
  },
  twitter: {
    ...
    title: "RedBlack Agency - Bold Marketing That Drives Results",
    description: "Transform your business with powerful marketing campaigns that deliver measurable growth.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1763138766365-waqqmfei.jpg"]
  },
  robots: {
    index: true,
    follow: true
